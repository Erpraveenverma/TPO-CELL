...
try {
    ...
    String sql ="SELECT * from job_data";
						 			...
						 			<tbody>
										...
										%>
						 				<tr>
						 					...
						 					<td>
						 						<div class="table-list-title">
						 							<h3><a href="#" title=""><%=skill %> </a></h3>
						 							<span><i class="la la-money"></i><%=salary %></span>
						 						</div>
						 					</td>
						 					<td>
						 						<ul class="action_job">
						 							<li ><span>Delete</span><a href="admin_delete_job.jsp?jid=<%=job_id %>" title=""><i class="la la-trash-o"></i></a>
						 							</li>
