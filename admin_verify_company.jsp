...
try {
    ...
    String sql ="SELECT * from company_data where status='"+status+"'";
						 			...
						 			<tbody>
										...
										%>
						 				<tr>
						 					...
						 					<td>
						 						<span class="status active"><%=website %></span>
						 					</td>
						 					<td>
						 						<ul class="action_job">
						 							<li><span>Verify</span><a href="verify_compny.jsp?EID=<%=email %>" title=""><i class="la la-eye"></i></a></li>
						 							<li ><span>Delete</span><a href="delete_company.jsp?EID=<%=email %>" title=""><i class="la la-trash-o"></i></a>
						 							</li>
