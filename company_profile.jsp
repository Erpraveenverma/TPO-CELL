...
try {
    ...
    String sql ="SELECT * from company_data where email='"+ID+"'";
					 			...
					 			<form method="post" action="company_profile_update.jsp">
					 				<div class="row">
					 					...
					 					<div class="col-lg-4">
					 						...
					 						<div class="pf-field">
					 							<input type="text"  value="<%=contact  %>" name="contact" maxlength="10"/>
					 						</div>
					 					</div>
					 					<div class="col-lg-4">
					 					...
					 					<div class="col-lg-4">
					 						...
					 						<div class="pf-field">
					 							<input type="url" placeholder="www.Comapny.com" value="<%=website  %>" name="website"/>
					 						</div>
					 					</div>
					 					</div>
					 					...
					 					<div class="col-lg-6">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="www.facebook.com/Comapny" value="<%=facebook  %>" name="facebook"/>
					 					...
					 					<div class="col-lg-6">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="www.twitter.com/Comapny" value="<%=twitter  %>" name="twitter"/>
					 					...
					 					<div class="col-lg-6">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="www.google-plus.com/Comapny" value="<%=google  %>" name="google"/>
					 					...
					 					<div class="col-lg-6">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="www.Linkedin.com/Comapny" value="<%=linkedin  %>" name="linkedin"/>
