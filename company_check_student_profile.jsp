...
try {
    ...
    String sql ="SELECT * from student_data where email='"+eid+"'";
		...
		<div class="menu-sec">
			<div class="container">
				...
				<div class="btns-profiles-sec">
					<span><img src="images/resource/company1.jpg" alt="" /> <%=name %> <i class="la la-angle-down"></i></span>
					<ul>
					 			...
					 			<form >
					 				<div class="row">
					 					<div class="col-lg-6">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="Name" value="<%=name %>" name="name" readonly/>
					 						</div>
					 					</div>
					 					...
					 					<div class="col-lg-6">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="Roll No" value="<%=rollno %>" name="roll_no" readonly/>
					 						</div>
					 					</div>
					 					...
					 					<div class="col-lg-6">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="" value="<%=department %>" name="department" readonly/>
					 						</div>
					 					</div>
					 			...
					 			<h3>Contact</h3>
					 				...
					 				<div class="row">
					 					<div class="col-lg-4">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="+91 7494963626" value="<%=contact %>" name="contact" readonly/>
					 						</div>
					 					</div>
					 					<div class="col-lg-4">
					 						<span class="pf-title">Email</span>
					 						<div class="pf-field">
					 							<input type="text" placeholder="demo@Student.com" value="<%=email %>" name="email" readonly/>
					 						</div>
					 					</div>
					 					<div class="col-lg-4">
					 						<span class="pf-title">Website</span>
					 						<div class="pf-field">
					 							<input type="text" placeholder="www.Student.com" value="<%=website %>" name="website" readonly/>
					 						</div>
					 					</div>
					 			...
					 			<h3>Social Edit</h3>
					 				...
					 				<div class="row">
					 					<div class="col-lg-6">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="www.facebook.com/Student" value="<%=facebook %>" name="facebook" readonly/>
					 					...
					 					<div class="col-lg-6">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="www.twitter.com/Student" value="<%=twitter %>" name="twitter" readonly/>
					 					...
					 					<div class="col-lg-6">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="www.google-plus.com/Student" value="<%=google %>" name="google" readonly/>
					 					...
					 					<div class="col-lg-6">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="www.Linkedin.com/Student" value="<%=linkedin %>" name="linkedin" readonly/>
