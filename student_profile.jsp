...
try {
    ...
    String sql ="SELECT * from student_data where email='"+ID+"'";
		...
		<div class="menu-sec">
			<div class="container">
				...
				<div class="my-profiles-sec">
					<span><%=name %> <i class="la la-bars"></i></span>
				</div>
				 	...
				 	<div class="col-lg-9 column">
				 		<div class="padding-left">
					 		...
					 		<div class="profile-form-edit">
					 			<form method="post" action="student_profile_update.jsp">
					 				<div class="row">
					 					<div class="col-lg-6">
					 			...
					 			<h3>Contact</h3>
					 				...
					 				<div class="row">
					 					<div class="col-lg-4">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="+91 7494963626" value="<%=contact %>" name="contact"/>
					 						</div>
					 					</div>
					 					<div class="col-lg-4">
					 					...
					 					<div class="col-lg-4">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="www.Student.com" value="<%=website %>" name="website"/>
					 						</div>
					 					</div>
					 			...
					 			<h3>Social Edit</h3>
					 				...
					 				<div class="row">
					 					<div class="col-lg-6">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="www.facebook.com/Student" value="<%=facebook %>" name="facebook"/>
					 					...
					 					<div class="col-lg-6">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="www.twitter.com/Student" value="<%=twitter %>" name="twitter"/>
					 					...
					 					<div class="col-lg-6">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="www.google-plus.com/Student" value="<%=google %>" name="google"/>
					 					...
					 					<div class="col-lg-6">
					 						...
					 						<div class="pf-field">
					 							<input type="text" placeholder="www.Linkedin.com/Student" value="<%=linkedin %>" name="linkedin"/>
