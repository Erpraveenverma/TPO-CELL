...
try {
    ...
    String sql ="SELECT student_email from applied_job where job_ID='"+jid+"'";
				 	...
				 	<div class="col-lg-9 column">
				 		<div class="padding-left">
					 		<div class="manage-jobs-sec">
					 			<h3>Students Who Applied Jobs</h3>
						 		...
						 		<table>
						 			...
						 			<tbody>
			    						...
			    						String sql1 ="SELECT name,roll_no,email,contact_no,department from student_data where email='"+student_email+"'";
						 				...
						 				<tr>
						 					<td>
						 						<div class="table-list-title">
						 							<h3><a href="company_check_student_profile.jsp?eid=<%=email%>" title=""><%=name %></a></h3>
    							...
    							out.println("Unable to connect to database 1.");
								out.println(ex1);}
